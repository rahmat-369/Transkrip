      ...
      <div className="absolute inset-0 flex items-end sm:items-center justify-center p-4">
        <div
          className={[
            ...
            open ? "translate-y-0 scale-100" : "translate-y-6 scale-[0.96]",
          ].join(" ")}
          role="dialog"
          aria-modal="true"
          aria-label={title}
...
- Jangan pakai emoji.`;
  ...
  return (
    <div
      className={`h-[100dvh] text-[#111111] font-sans selection:bg-[#111111] selection:text-white relative overflow-hidden transition-opacity duration-1000 ${
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute top-[-12%] left-[-12%] w-[28rem] h-[28rem] bg-indigo-200 rounded-full mix-blend-multiply filter blur-[120px] opacity-20 animate-pulse pointer-events-none" />
        <div
          className="absolute bottom-[-12%] right-[-12%] w-[30rem] h-[30rem] bg-gray-200 rounded-full mix-blend-multiply filter blur-[120px] opacity-30 pointer-events-none"
      ...
      <header className="fixed top-0 left-0 right-0 z-30 bg-[#FBFBFB]/70 backdrop-blur-xl border-b border-gray-200/60 shadow-sm transition-all duration-300">
      ...
      <main className="fixed left-0 right-0 top-16 bottom-[72px] z-10 overflow-y-auto overscroll-contain custom-scrollbar">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-14">
          <section className={`w-full text-center space-y-6 sm:space-y-8 transition-all duration-700 ${isMounted ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"}`}>
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 border border-gray-200/70 shadow-sm text-sm font-medium text-gray-700 mb-2 hover:shadow-md transition-shadow cursor-default animate-bounce" style={{ animationDuration: "3s" }}>
                <Sparkles size={16} className="text-indigo-600" />
                Ekstrak otomatis dengan AI
              </div>

              <h2 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tight text-[#111111] leading-tight drop-shadow-sm px-2">
            ...
            <form
              ...
              className="max-w-2xl mx-auto relative flex flex-col sm:flex-row gap-3 p-2 bg-white/90 rounded-2xl sm:rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-200 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)] focus-within:ring-4 focus-within:ring-indigo-500/10 focus-within:border-indigo-300"
              style={{ WebkitTapHighlightColor: "transparent" }}
            >
              <div className="relative flex-grow flex items-center">
                ...
                <input
                  ...
                  className="block w-full pl-14 pr-4 py-4 sm:py-0 bg-transparent text-sm sm:text-base font-medium placeholder-gray-400 outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 transition-all"
              ...
              <button
                type="submit"
                disabled={loading}
                className="group relative flex items-center justify-center gap-2 py-4 px-8 font-bold rounded-xl sm:rounded-full text-white bg-gray-900 hover:bg-black active:scale-[0.98] transition-all duration-300 overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none shadow-md"
                style={{ WebkitTapHighlightColor: "transparent" }}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-3xl mx-auto mt-6 text-left px-4">
              <div className="p-4 bg-white/50 backdrop-blur-sm border border-gray-200/70 rounded-2xl flex items-start gap-3">
          ...
          <div className={`w-full max-w-3xl mx-auto mt-10 transition-all duration-700 ease-out transform origin-top pb-10 ${transcript ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-6 scale-95 pointer-events-none hidden"}`}>
            <section className="bg-white/90 border border-gray-200 rounded-3xl shadow-xl shadow-black/5 overflow-hidden backdrop-blur">
              <div className="flex items-center justify-between px-5 sm:px-8 py-4 border-b border-gray-200 bg-gray-50/80">
                <h3 className="font-extrabold text-gray-900 flex items-center gap-2.5">
                  <div className="p-1.5 bg-white rounded-lg shadow-sm text-gray-700 border border-gray-200">
                    <FileText size={16} />
                  </div>
                  Hasil Transkrip
                </h3>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 text-sm font-bold rounded-xl border transition-all duration-200 active:scale-95 ${
                    copied ? "bg-gray-900 border-gray-900 text-white shadow-sm" : "bg-white border-gray-200 text-gray-700 hover:bg-gray-50 shadow-sm"
                  }`}
                  style={{ WebkitTapHighlightColor: "transparent" }}
                  disabled={!transcript}
                >
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-30 border-t border-gray-200/70 bg-white/70 backdrop-blur-xl">
      ...
      <div className="fixed bottom-[90px] right-4 z-[80] flex flex-col items-end gap-3">
        {/* Expanded Menu Options */}
        <div 
          className={`flex flex-col gap-3 transition-all duration-300 origin-bottom right-0 ${
            fabOpen ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-90 pointer-events-none"
          }`}
        >
          <div className="flex items-center gap-3 justify-end">
            ...
            <button
              onClick={() => { setContactOpen(true); setFabOpen(false); }}
              className="h-12 w-12 rounded-full bg-white text-gray-700 border border-gray-200 shadow-lg grid place-items-center hover:bg-gray-50 active:scale-95 transition"
              aria-label="Kontak"
            >
              <Headset size={20} />
            </button>
          ...
          <div className="flex items-center gap-3 justify-end">
            ...
            <button
              onClick={() => { setAboutOpen(true); setFabOpen(false); }}
              className="h-12 w-12 rounded-full bg-white text-gray-700 border border-gray-200 shadow-lg grid place-items-center hover:bg-gray-50 active:scale-95 transition"
              aria-label="About"
            >
              <InfoIcon size={20} />
          ...
          <div className="flex items-center gap-3 justify-end">
            ...
            <button
              ...
              className="h-12 w-12 rounded-full bg-indigo-600 text-white shadow-lg shadow-indigo-500/30 grid place-items-center hover:bg-indigo-700 active:scale-95 transition"
              aria-label="Chat AI"
            >
      ...
      <DialogShell open={aboutOpen} onClose={() => setAboutOpen(false)} title="Tentang AI" subtitle="Asisten Konten Cerdas" icon={<Wand2 size={18} />}>
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <div className="text-sm font-semibold text-gray-600 leading-snug">Rangkuman, ide konten, chapters. Siap edit.</div>
          </div>
        </div>

        <div className="mt-4 rounded-2xl border border-gray-200 bg-indigo-50/50 p-4">
          <div className="text-sm font-extrabold text-gray-900">Cara pakai AI:</div>
          <ul className="mt-2 space-y-2 text-sm font-semibold text-gray-700">
            <li className="flex items-start gap-2"><span className="text-indigo-600">1.</span> Tempel hasil transkrip ke kolom chat.</li>
            <li className="flex items-start gap-2"><span className="text-indigo-600">2.</span> Pilih mode (Ringkasan/Ide Konten).</li>
            <li className="flex items-start gap-2"><span className="text-indigo-600">3.</span> Kirim, dan biarkan AI bekerja!</li>
          </ul>
        </div>
        ...
        <div className="mt-5 flex items-center justify-between">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-2xl bg-gray-900 text-white text-sm font-extrabold hover:bg-black active:scale-95 transition"
            style={{ WebkitTapHighlightColor: "transparent" }}
          >
            Tutup
          </button>
      ...
      <DialogShell open={historyOpen} onClose={() => setHistoryOpen(false)} title="Riwayat" subtitle="Transkrip & Obrolan AI" icon={<History size={18} />} widthClass="max-w-[680px]">
        <div className="grid grid-cols-1 gap-4">
          <CustomSelect
            ...
            options={[
              { value: "transcript", label: "Riwayat Transkrip" },
              { value: "chat", label: "Riwayat Chat AI" },
            ]}
          />
          ...
          {historyType === "transcript" ? (
            <>
              <div className="flex items-center justify-between gap-2">
                <div className="text-sm font-bold text-gray-700">
                  Total Tersimpan: <span className="text-gray-900">{transcriptHistory.length}</span>
                </div>
                <div className="flex items-center gap-2">
                  <button onClick={clearTranscriptHistory} className="px-3 py-2 rounded-xl bg-red-50 text-red-600 text-xs font-extrabold hover:bg-red-100 active:scale-95 transition">
                    Hapus Semua
                  </button>
                </div>
              </div>
                        ...
                        <div key={it.id} className="p-4 bg-white hover:bg-gray-50 transition">
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                            <div className="min-w-0 flex-1">
                              <div className="text-xs font-bold text-gray-400">{new Date(it.ts).toLocaleString("id-ID")}</div>
                            ...
                            <div className="flex items-center gap-2 shrink-0 mt-2 sm:mt-0">
                              <button
                                ...
                                className="px-4 py-2 rounded-xl bg-gray-900 text-white text-xs font-extrabold hover:bg-black active:scale-95 transition"
                              >
                                Buka
                              </button>
                              <button
                                onClick={() => copyText(it.transcript || "")}
                                className="h-8 w-8 rounded-xl border border-gray-200 bg-white grid place-items-center text-gray-700 hover:bg-gray-100 active:scale-95 transition"
                              >
                                <Copy size={14} />
                              </button>
                            </div>
            ...
            <>
              <div className="flex items-center justify-between gap-2">
                <div className="text-sm font-bold text-gray-700">
                  Total Tersimpan: <span className="text-gray-900">{chatHistory.length}</span>
                </div>
                <div className="flex items-center gap-2">
                  <button onClick={clearChatHistory} className="px-3 py-2 rounded-xl bg-red-50 text-red-600 text-xs font-extrabold hover:bg-red-100 active:scale-95 transition">
                    Hapus Semua
                  </button>
                </div>
              </div>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                            <div className="min-w-0 flex-1">
                              <div className="text-xs font-bold text-gray-400">
                                {new Date(it.ts).toLocaleString("id-ID")} • <span className="text-indigo-600 uppercase tracking-wider">{String(it.mode || "clip")}</span>
                              </div>
          ...
          <div className="flex items-center justify-end mt-2">
            <button
              ...
              className="px-5 py-2.5 rounded-2xl bg-gray-200 text-gray-900 text-sm font-extrabold hover:bg-gray-300 active:scale-95 transition"
            >
              Tutup
            </button>
          </div>
      ...
      <DialogShell open={contactOpen} onClose={() => setContactOpen(false)} title="Hubungi Admin" subtitle="Pilih platform di bawah" icon={<Headset size={18} />} widthClass="max-w-[480px]">
        <div className="rounded-2xl border border-gray-200 bg-white p-2 space-y-2">
          ...
          <a
            href={ADMIN.telegramLink}
            target="_blank"
            rel="noreferrer"
            className="w-full px-4 py-3.5 rounded-xl bg-[#F0F8FF] border border-[#B0E0E6] flex items-center justify-between gap-3 hover:bg-[#E1F0FF] active:scale-[0.98] transition-all"
            style={{ WebkitTapHighlightColor: "transparent" }}
          >
            <div className="min-w-0 flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-[#0088cc] text-white flex items-center justify-center shrink-0">
                <TelegramIcon size={20} />
              </div>
              <div className="text-left">
                <div className="text-sm font-extrabold text-[#0088cc]">Telegram</div>
                <div className="text-xs font-bold text-[#0088cc]/70 truncate">Tanya seputar AI & Tool</div>
              </div>
            </div>
            <ExternalLink size={18} className="text-[#0088cc]/60" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full px-4 py-3.5 rounded-xl bg-[#F0FFF4] border border-[#C6F6D5] flex items-center justify-between gap-3 hover:bg-[#E6FFEA] active:scale-[0.98] transition-all"
            style={{ WebkitTapHighlightColor: "transparent" }}
          >
            <div className="min-w-0 flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-sm font-extrabold text-[#128C7E]">WhatsApp</div>
                <div className="text-xs font-bold text-[#128C7E]/70 truncate">Join Chanel</div>
              </div>
            </div>
            <ExternalLink size={18} className="text-[#25D366]/60" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-white flex items-center justify-between gap-3 hover:bg-gray-50 active:scale-[0.98] transition-all"
            style={{ WebkitTapHighlightColor: "transparent" }}
          >
            <div className="min-w-0 flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-sm font-extrabold text-gray-900">TikTok</div>
                <div className="text-xs font-bold text-gray-500 truncate">Follow & Support</div>
              </div>
            </div>
          ...
          >
            <div className="min-w-0 flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-gray-100 text-gray-900 flex items-center justify-center shrink-0">
                <Github size={20} />
              </div>
              <div className="text-left">
                <div className="text-sm font-extrabold text-gray-900">GitHub</div>
                <div className="text-xs font-bold text-gray-500 truncate">Source Code</div>
              </div>
            </div>
            <ExternalLink size={18} className="text-gray-400" />
          </a>
      ...
      <div
        className={[
          "fixed bottom-[90px] right-4 z-[75]",
        ...
        <div className="flex flex-col h-full rounded-3xl overflow-hidden border border-gray-200 bg-[#FFFFFF] shadow-[0_24px_60px_-15px_rgba(0,0,0,0.3)]">
          ...
          <div className="px-4 py-3 border-b border-gray-200 bg-[#FFFFFF] flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="h-9 w-9 rounded-full bg-indigo-600 text-white flex items-center justify-center shadow-md">
                <Bot size={18} />
              </div>
              <div className="min-w-0">
                <div className="text-sm font-extrabold text-gray-900 leading-tight">Asisten AI</div>
                <div className="text-[11px] font-bold text-indigo-600 leading-tight">Online</div>
              </div>
            </div>
            <button
              onClick={() => setChatOpen(false)}
              className="h-8 w-8 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 active:scale-95 transition"
          ...
          <div className="px-4 py-3 border-b border-gray-200 bg-gray-50 shrink-0 space-y-2">
            <CustomSelect
              ...
              options={[
                { value: "clip", label: "✨ Cari Ide Konten Pendek" },
                { value: "summary", label: "📝 Buat Ringkasan Otomatis" },
                { value: "chapters", label: "⏱️ Buat Chapters (Waktu)" },
                { value: "rewrite", label: "✍️ Tulis Ulang Script" },
              ]}
            ...
            <textarea
              ...
              placeholder="Instruksi spesifik (opsional)"
              className="w-full h-10 rounded-xl bg-white border border-gray-200 px-3 py-2 text-xs font-semibold text-gray-800 outline-none resize-none focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100 transition-all custom-scrollbar"
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50/50 p-4 space-y-3 custom-scrollbar" ref={chatListRef}>
            {chatMessages.map((m, idx) => {
              ...
              return (
                <div key={idx} className={["w-full flex", isUser ? "justify-end" : "justify-start"].join(" ")}>
                  <div
                    className={[
                      "max-w-[88%] rounded-2xl px-3.5 py-2.5 text-[13px] font-semibold leading-relaxed whitespace-pre-wrap shadow-sm",
                      isUser ? "bg-gray-900 text-white rounded-tr-sm" : "bg-white border border-gray-200 text-gray-800 rounded-tl-sm",
                    ].join(" ")}
                  >
                    <div>{m.content}</div>
                    ...
                    {isAssistant && (
                      <div className="pt-2 mt-2 border-t border-gray-100 flex items-center justify-end">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 active:scale-95 transition"
            ...
            {chatSending && (
              <div className="w-full flex justify-start">
                <div className="max-w-[80%] rounded-2xl px-4 py-3 bg-white border border-gray-200 rounded-tl-sm shadow-sm">
                  <TypingDots />
                </div>
              </div>
            )}
          ...
          <div className="p-3 bg-white border-t border-gray-200 shrink-0">
            <div className="flex items-end gap-2 bg-gray-50 border border-gray-200 rounded-2xl p-1 focus-within:border-indigo-300 focus-within:bg-white transition-colors">
              <textarea
                ...
                placeholder="Tempel transkrip ke sini..."
                className="flex-1 max-h-[100px] min-h-[40px] bg-transparent px-3 py-2 text-sm font-semibold text-gray-800 outline-none resize-none custom-scrollbar"
                style={{ WebkitTapHighlightColor: "transparent", WebkitAppearance: "none" }}
                disabled={chatSending}
              />
              ...
              <div className="flex items-center gap-1 pb-1 pr-1">
                 <button
                  ...
                  className="h-8 w-8 rounded-xl text-gray-400 hover:text-red-500 hover:bg-red-50 grid place-items-center active:scale-95 transition disabled:opacity-30"
                ...
                <button
                  ...
                  className="h-9 w-9 rounded-xl bg-indigo-600 text-white grid place-items-center hover:bg-indigo-700 active:scale-95 transition disabled:opacity-50 shadow-md"
                  aria-label="Kirim"
                >
                  {chatSending ? <Loader2 className="animate-spin" size={16} /> : <Send size={16} className="-ml-0.5" />}
                </button>
              </div>
            </div>
          </div>
